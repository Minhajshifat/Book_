"""
Django settings for bookgarden project.
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ["https://book-vnak.onrender.com", "https://*.127.0.0.1"]
...
WSGI_APPLICATION = "bookgarden.wsgi.application"
